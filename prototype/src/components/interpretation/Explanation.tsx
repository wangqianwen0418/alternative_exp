...
import TwoColorScatter from "components/charts/TwoColorScatter";
import {
  initVisAtom,
  insightAtom,
  isSubmittedAtom,
...
import {
  ...
  variableMapping,
} from "lib/datasets/diabetesData";
...
export default function Explanation() {
  ...
  const [, setTutorialOverride] = useAtom(tutorialOverrideAtom);
      ...
      case "SCATTER":
        additionalVisualizations = isSubmitted && (
          <Scatter
            ...
            yValues={variableMapping[graph.yValues] || diabetes_bmi_shapValues}
            width={600}
            height={400}
