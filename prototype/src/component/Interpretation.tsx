...
import { CASES, TInsight, GenerateTextTemplates, TCase } from "../const";
import { generatePrompt, parseInput } from "../const/prompt";
    ...
    <>
      <Paper style={{ padding: "15px" }}>
        ...
        <TextField
          ...
          value={userText}
          //   onChange={(e) =>
          //     caseName.includes("Free") && setUserInput(e.target.value)
          //   }
          multiline
          rows={4}
          fullWidth
