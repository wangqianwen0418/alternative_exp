...
export default function Interpretation(props: props) {
    ...
    const [userInput, setUserInput] = useState(
        userText || "e.g., a high bmi leads to large diabete progression"
    );
    ...
    return (
        <Paper style={{ padding: "15px" }}>
            ...
            <TextField
                ...
                label="freeform text"
                value={userInput}
                onChange={(e) => props.name.includes("Free") && setUserInput(e.target.value)}
                multiline
                rows={4}
                fullWidth
