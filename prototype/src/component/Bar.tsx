...
export default function Bar(props: BarProps) {
    ...
    const yScale = d3.scaleBand().domain(sortedAvgShapeValues.map(d => d[0])).range([margin[1], height - margin[3]]).padding(0.1)
    ...
    >
        ...
        <text x={width / 2} y={height - 5} textAnchor='middle'> Average contribution to the prediction</text>
    </g>
}