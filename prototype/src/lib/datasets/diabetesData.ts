import shap_diabetes from "data/diabetes/shap_diabetes.json";

export const diabetes_s5 = "serum triglycerides level",
  diabetes_s5_featureIndex = shap_diabetes["feature_names"].indexOf(diabetes_s5),
...
export const diabetes_bmi = "bmi",
  diabetes_bmi_featureIndex = shap_diabetes["feature_names"].indexOf(diabetes_bmi),
...
export const diabetes_bp = "blood pressure",
  diabetes_bp_featureIndex = shap_diabetes["feature_names"].indexOf(diabetes_bp),
...
export const diabetes_s3 = "high-density lipoproteins",
  diabetes_s3_featureIndex = shap_diabetes["feature_names"].indexOf(diabetes_s3),
...
export const diabetes_s6 = "blood sugar level",
  diabetes_s6_featureIndex = shap_diabetes["feature_names"].indexOf(diabetes_s6),
...
export const diabetes_age = "age",
  diabetes_age_featureIndex = shap_diabetes["feature_names"].indexOf(diabetes_age),
...
export const diabetes_s2 = "low-density lipoproteins",
  diabetes_s2_featureIndex = shap_diabetes["feature_names"].indexOf(diabetes_s2),
...
export const diabetes_sex = "sex",
  diabetes_sex_featureIndex = shap_diabetes["feature_names"].indexOf(diabetes_sex),
...
export const diabetes_s1 = "serum cholesterol",
  diabetes_s1_featureIndex = shap_diabetes["feature_names"].indexOf(diabetes_s2),
...
export const diabetes_s4 = "total/HDL cholesterol ratio",
  diabetes_s4_featureIndex = shap_diabetes["feature_names"].indexOf(diabetes_s2),
